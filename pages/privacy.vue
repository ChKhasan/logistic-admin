<template lang="html">
  <div class="container">
    <div class="post-outer">
      <div class="post">
        <h3 class="post-title entry-title">Privacy Policy</h3>
        ...
        <div class="post-header">
          <div class="post-header-line-1">
            <span class="byline post-timestamp">
              <meta
                content="https://mylogistndc.blogspot.com/2024/05/privacy-policy.html"
              />
              <a
                class="timestamp-link"
                href="https://mylogistndc.blogspot.com/2024/05/privacy-policy.html"
                rel="bookmark"
                title="permanent link"
              >
                <time
                  class="published"
                  datetime="2024-05-01T03:03:00-07:00"
                  title="2024-05-01T03:03:00-07:00"
                >
                  мая 03, 2024
                </time>
              </a>
        ...
        <div
          ...
          id="post-body-5250770035609409882"
        >
          <p
            style="
            ...
            "
          >
            This privacy policy applies to the MyLogist (Driver) app (hereby referred to
            as "Application") for mobile devices that was created by NDC (hereby referred
            to as "Service Provider") as a Free service. This service is intended for use
            "Logistics".
          </p>
          <p>
            <br
          ...
          >
            ...
            including but not limited to Phone number, Name, Age. The information that the
          ...
          >
            ...
            <li
              ...
              "
            >
              with their trusted services providers who work on their behalf, do not have
          ...
          >
            ...
            User Provided Data that you have provided via the Application, please contact
            them at info@mylogist.uz and they will respond in a reasonable time.
          </p>
          <p>
            <br
              style="
          ...
          >
            ...
            >
              ...
              children under 13 years of age. In the case the Service Provider discover
              that a child under 13 has provided personal information, the Service
              Provider will immediately delete this from their servers. If you are a
              ...
              (info@mylogist.uz<span color="rgb(26 26 26 / var(--tw-text-opacity))"
                >) so that they will be able to take the necessary actions.</span
              >
            </p>
          </div>
          <p>
          ...
          >
            <span style="color: #1a1a1a"
              ...
              email at info@mylogist.uz</span
            >
          </p>
        </div>
        <div class="post-bottom">
          ...
          <div class="post-share-buttons post-share-buttons-bottom">
            <div class="byline post-share-buttons goog-inline-block">
              <div
                aria-owns="sharing-popup-Blog1-byline-5250770035609409882"
                class="sharing"
                data-title="Privacy Policy "
              >
                <button
                  aria-controls="sharing-popup-Blog1-byline-5250770035609409882"
                  aria-label="Поделиться"
                  class="sharing-button touch-icon-button"
                  id="sharing-button-Blog1-byline-5250770035609409882"
                  role="button"
                  aria-expanded="false"
                  aria-haspopup="true"
                >
                  <div class="flat-icon-button ripple">
                    <svg class="svg-icon-24">
                      <use
                        xlink:href="/responsive/sprite_v1_6.css.svg#ic_share_black_24dp"
